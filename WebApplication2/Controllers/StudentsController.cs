...
namespace WebApplication2.Controllers
{
    ...
    {
        private StudentContainer db = new StudentContainer();
        ...
        public ActionResult Create([Bind(Include = "Id,Name,BatchId")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,BatchId")] Student student)
        {
            if (ModelState.IsValid)
            {
